    ...
    return (
      <Grid>
        <Row>
          ...
          <p> </p>
          <p>
          Digtalbihar recognizes the importance of privacy of its users and also of maintaining 
          ...
          Information (defined hereunder) by digitalBihar and its subsidiaries and affiliates.{' '}
          </p>
          <p>
            This Privacy Policy is applicable to any person (‘User’) who
            purchases, intends to purchase, or inquire about any product(s) or
            service(s) made available by digtal bihar through any of digtal
            bihar's customer interface channels including its website, mobile
            site, mobile app &amp; offline channels including call centers and
            offices (collectively referred herein as <b>"Sales Channels"</b>).{' '}
          </p>
          <p>
            For the purpose of this Privacy Policy, wherever the context so
            requires "you" or "your" shall mean User and the term "we", "us",
            "our" shall mean digtal bihar. For the purpose of this Privacy
          ...
          <p>
            ...
            herein. If you disagree with this Privacy Policy please do not use
            or access our Website or other Sales Channels.{' '}
          </p>
          <p>
            ...
            are linked to our Website. User should take note that information
            and privacy practices of digtal bihar’s business partners,
            advertisers, sponsors or other sites to which digtal bihar provides
            hyperlink(s), may be materially different from this Privacy Policy.
          ...
          <p>
            ...
            digtal bihar and all capitalized terms used, but not otherwise
          ...
          <p> </p>
          <p>
            Please note that the data shared with digtal bihar shall be
            primarily processed in India and such other jurisdictions where a
            third party engaged by digtal bihar may process the data on digtal
            bihar’s behalf. By agreeing to this policy, you are providing digtal
            bihar with your explicit consent to process your personal
            information for the purpose(s) defined in this policy. The data
            protection regulations in India or such other jurisdictions
          ...
          <p>
            ...
            email id: privacy@digtalbihar.com. However, if such processing of
            data is essential for us to be able to provide service to you, then
            we may not be able to serve or confirm your bookings after your
            withdrawal of consent. For instance, if you want to book a bus
            journey, then certain personal information of yours like contact
            details, gender, location details etc. may have to be shared by us
            with our bus operator and they may further process this information
          ...
          <ol>
            <li>
              {' '}
              severely inhibit our ability to serve you properly and in such
              case, we may have to refuse the booking altogether, or{' '}
            </li>
            <li>
              {' '}
              unreasonably restrict us to service your booking (if a booking is
              already made) which may further affect your trip or may compel us
          ...
          <p>
            {' '}
            <strong>"Personal Information"</strong> of User shall include the
            information shared by the User and collected by us for the following
            purposes:{' '}
          </p>
          <p>
            {' '}
            <b>1. Registration on the Website: </b> Information which you
            provide while subscribing to or registering on the Website,
            including but not limited to information about your personal
            identity such as name, gender, age etc., your contact details such
            as your email address, postal addresses, telephone (mobile or
            otherwise) and/or fax numbers. The information may also include
            information such as your banking details (including credit/debit
            card) and any other information relating to your income and/or
            lifestyle; billing information payment history etc. (as shared by
            you).{' '}
          </p>
          <p>
            {' '}
            <b>2. Other information: </b> We many also collect some other
          ...
          <ol>
            ...
            <li>
              ...
              booking through your registered digtal bihar account. In such
              ...
              shared by us with the concerned service provider(s).{' '}
            </li>
          </ol>
          <p />
          <p>
            {' '}
            <strong>D. HOW WE USE YOUR PERSONAL INFORMATION</strong>{' '}
          </p>
          <p>
            {' '}
          ...
          <p />{' '}
          <b>
            2. We may also use your Personal Information for several reasons
          ...
          <p>
            digtal bihar provides an option to its users to post their
            experiences by way of review, ratings and general poll questions.
            The customers also have an option of posting questions w.r.t a
            service offered by digtal bihar or post answers to questions raised
            by other users. digtal bihar may also hire a third party to contact
            you and gather feedback about your recent booking with digtal bihar.
            Though the participation in the feedback process is purely optional,
            you may still receive emails, notifications (SMS, Whatsapp or any
            other messaging service) for you to share your feedback. The reviews
            may be written or in a video format. The reviews written or posted
            may also be visible on other travel or travel related platforms.
          </p>
          <p /> The UGC that digtal bihar collect may be of the following kinds:
          <ol>
          ...
          <p>
            {' '}
            <b>4. MARKETING PROMOTIONS, RESEARCH AND PROGRAMS:</b>
          </p>
          <p>
            Marketing promotions, research and programs help us to identify your
            preferences, develop programs and improve user experience. digtal
            bihar frequently sponsors promotions to give its Users the
            opportunity to win great travel and travel related prizes. Personal
            Information collected by us for such activities may include contact
            information and survey questions. We use such Personal Information
            to notify contest winners and survey information to develop
            promotions and product improvements. As a registered User, you will
            also occasionally receive updates from us about fare sales in your
            area, special offers, new digtal bihar services, other noteworthy
            items (like savings and benefits on bus tickets, hotel reservations,
            pilgrimage packages, car rentals and other travel services) and
            marketing programs.{' '}
          </p>
          <p>
            {' '}
          ...
          <p>
            {' '}
            digtal bihar may from time to time launch reward programs by way of
            which users may stand to win travel related rewards or other
            rewards. We may use your Personal Information to enroll you in the
            rewards program and status of the same will be visible each time you
            log in to the Website. Depending on the reward program, each time
            you win a reward, digtal bihar may share your Personal Information
            with a third party that will be responsible for fulfilling the
            reward to you. You may however choose to opt out of such reward
            programs by writing to us. For various purposes such as fraud
            detection, offering bookings on credit etc., we at times may verify
            information of customers on selective basis, including their credit
            information.{' '}
          </p>
          <p />
          <p>
            {' '}
            <b>E. HOW LONG DO WE KEEP YOUR PERSONAL INFORMATION?</b>{' '}
          </p>
          <p>
            {' '}
            digtal bihar will retain your Personal Information on its servers
            for as long as is reasonably necessary for the purposes listed in
            this policy. In some circumstances we may retain your Personal
            Information for longer periods of time, for instance where we are
            required to do so in accordance with any legal, regulatory, tax or
          ...
          <p>
            {' '}
            <b>F. COOKIES AND SESSION DATA</b>{' '}
          </p>
          <p> </p>
          <p>
            <b>1. Cookies</b>
          ...
          <p>
            {' '}
            digtal bihar uses cookies to personalize your experience on the
            Website and the advertisements that maybe displayed. digtal bihar’s
          ...
          <p>
            ...
            by your browser. digtal bihar supports your right to block any
            unwanted Internet activity, especially that of unscrupulous
            websites. However, blocking digtal bihar cookies may disable certain
            features on the Website, and may hinder an otherwise seamless
            experience to purchase or use certain services available on the
            Website. Please note that it is possible to block cookie activity
            from certain websites while permitting cookies from websites you
            trust.{' '}
          </p>
          <p />
          <p>
          ...
          <p>
            {' '}
            <b>G. WITH WHOM YOUR PERSONAL INFORMATION IS SHARED</b>{' '}
          </p>
          <p>
            {' '}
          ...
          <p>
            ...
            hotels, bus service providers, cab rental or any other suppliers who
            are responsible for fulfilling your booking. You may note that while
            making a booking with digtal bihar you authorize us to share your
            information with the said service providers and suppliers. It is
            pertinent to note that digtal bihar does not authorize the end
            ...
            them is beyond the purview and control of digtal bihar as they
            process Personal Information as independent data controllers, and
            hence we cannot be made accountable for the same. You are therefore
            advised to review the privacy policies of the respective service
            provider or supplier whose services you choose to avail.{' '}
          </p>
          <p>
            {' '}
            digtal bihar does not sell or rent individual customer names or
          ...
          <p>
            {' '}
            <b>2. COMPANIES IN THE SAME GROUP:</b>{' '}
          </p>
          <p>
            {' '}
          ...
          <p>
            {' '}
            If the assets of digtal bihar are acquired, our customer information
            ...
            part of such restructuring exercise customer information including
            the Personal Information collected herein shall be transferred
            accordingly.{' '}
          </p>
          <p>
            {' '}
            <b>3. BUSINESS PARTNERS AND THIRD-PARTY VENDORS:</b>{' '}
          </p>
          <p>
            {' '}
            ...
            made for digtal bihar customers. Examples of such partners are
            entities offering co-branded credit cards, travel insurance,
            insurance cover against loss of wallet, banking cards or similar
            sensitive information etc. If you choose to avail any such services
            offered by our business partners, the services so availed will be
            governed by the privacy policy of the respective service provider.{' '}
          </p>
          <p>
            {' '}
            digtal bihar may share your Personal Information to third party that
            digtal bihar may engage to perform certain tasks on its behalf,
          ...
          <p>
            {' '}
            Occasionally, digtal bihar will hire a third party for market
          ...
          <p>
            {' '}
            In addition to the circumstances described above, digtal bihar may
          ...
          <ol>
            ...
            <li>
              to enforce or protect our rights or properties of digtal bihar or
          ...
          <p>
            ...
            sales in your area, special offers, new digtal bihar services, and
            other noteworthy items. We hope you will find these updates
            interesting and informative. If you wish not to receive them, please
          ...
          <p>
            {' '}
            When the digtal bihar app is installed on your phone or tablet, a
            list of permissions appear and are needed for the app to function
            effectively. There is no option to customize the list. The
            permissions that digtal bihar requires and the data that shall be
            accessed and its use is as below:{' '}
          </p>
          <p>
            {' '}
            <b>1. Android permissions:</b>{' '}
          </p>
          <ol>
            <li>
              <b>Device and App history:</b>We need your device permission to
              get information about your device, like OS (operating system)
              name, OS version, mobile network, hardware model, unique device
              identifier, preferred language, etc. Basis these inputs, we intend
              to optimize your travel booking experience.
            </li>
            <li>
              <b>Identity:</b>This permission enables us to know about details
              of your account(s) on your mobile device. We use this info to
              auto-fill your email ID’s and provide a typing free experience. It
              also helps us map email ID’s to a particular user to give you the
              benefit of exclusive travel offers, wallet cash-backs, etc. It
              also allows facilitating your Facebook and Google+ login.
            </li>
            <li>
              <b>Location:</b>This permission enables us to give you the benefit
              of location specific deals and provide you a personalized
              experience. When you launch digtal bihar app to make a travel
              booking, we auto-detect your location so that your nearest city is
              auto-filled. We also require this permission to be able to help
              you track your bus with respect to your location.
            </li>
            <li>
              <b>SMS:</b>If you allow us to access your SMS, we read your SMS to
              autofill or prepopulate ‘OTP’ while making a transaction and to
              validate your mobile number. This provides you a seamless purchase
              experience while making a booking and you don’t need to move out
              of the app to read the SMS and then enter it in the app.
            </li>
            <li>
              <b>Phone:</b>The app requires access to make phone calls so that
              you can make phone calls to bus operators, hotels and our customer
              contact centers directly through the app.
            </li>
            <li>
              <b>Contacts:</b>If you allow us to access your contacts, it
              enables us to provide a lot of social features to you such as
              sharing tickets or location with your friends. This permission
              also allows you to select numbers from your contacts for mobile
              recharges done on the app.
            </li>
            <li>
              <b>Photo/ Media/ Files:</b>The libraries in the app use these
              permissions to allow users to to save and upload multimedia
              reviews.
            </li>
            <li>
              <b>Wi-Fi connection information:</b>When you allow us the
              permission to detect your Wi-Fi connection, we optimize your
              bandwidth usage for multimedia uploads.
            </li>
            <li>
              <b>Device ID and Call information:</b>This permission is used to
              detect your Android ID through which we can uniquely identify
              users. It also lets us know your contact details using which we
              pre-populate specific fields to ensure a seamless booking
              experience.
            </li>
            <li>
              <b>Camera:</b>This permission is used to capture pictures of the
              boarding point or bus before the journey. This images can then
              uploaded as part of multimedia reviews.
            </li>
            <li>
              <b>Calendar:</b>This permission enables us to put your travel
              plans on your calendar.
            </li>
          </ol>
          <p>
            {' '}
            <b>2. IOS permissions:</b>{' '}
          </p>
          <ol>
            <li>
              <b>Notifications:</b>If you opt in for notifications, it enables
              us to send across exclusive deals, promotional offers, travel
              related updates, etc. on your device. If you do not opt for this,
              updates for your travel like booking confirmation, refund (in case
              of cancellation), etc. will be sent through SMS.
            </li>
            <li>
              <b>Contacts:</b>This permission enables us to know about details
              of your account(s) on your mobile device. We use this info to
              auto-fill your email ID’s and provide a typing free experience. It
              also helps us map email ID’s to a particular user to give you the
              benefit of exclusive travel offers, wallet cash-backs, etc. It
          ...
          <p>
            {' '}
            <b>J. HOW WE PROTECT YOUR PERSONAL INFORMATION?</b>{' '}
          </p>
          <p>
            {' '}
            ...
            Security) encryption. TLS is a proven coding system that lets your
            browser automatically encrypt, or scramble, data before you send it
            to us. Website has stringent security measures in place to protect
          ...
          <p>
            {' '}
            <b>K. WITHDRAWAL OF CONSENT AND PERMISSION</b>{' '}
          </p>
          <p>
            {' '}
            ...
            sending an email to privacy@digtalbihar.com{' '}
          </p>
          <p>
            {' '}
            <b>L. YOUR RIGHTS QUA PERSONAL INFORMATION</b>{' '}
          </p>
          <p>
            {' '}
            You may access your Personal Information from your user account with
            digtal bihar. You may also correct your personal information or
            ...
            you write to privacy@digtalbihar.com{' '}
          </p>
          <p>
            {' '}
            <b>M. ELIGIBILITY TO TRANSACT WITH digtal bihar</b>{' '}
          </p>
          <p>
            {' '}
          ...
          <p>
            {' '}
            <b>N. CHANGES TO THE PRIVACY POLICY</b>{' '}
          </p>
          <p>
            {' '}
            You must atleast 18 years of age to transact directly with digtal
            bihar and also to consent to the processing of your personal data.{' '}
          </p>
          <p>
            {' '}
            <b>
              You may always submit concerns regarding this Privacy Policy via
              email to us at privacy@digtalbihar.com. digtal bihar shall
              endeavor to respond to all reasonable concerns and inquiries.{' '}
            </b>
          </p>
        </Row>
      </Grid>
